...
public class ATNConfig
{
    ...
    public static Antlr4.Runtime.Atn.ATNConfig Create([NotNull] ATNState state, int alt, PredictionContext? context)
    {
        return Create(state, alt, context, Antlr4.Runtime.Atn.SemanticContext.None, null);
    }

    public static Antlr4.Runtime.Atn.ATNConfig Create([NotNull] ATNState state, int alt, PredictionContext? context, [NotNull] Antlr4.Runtime.Atn.SemanticContext semanticContext)
    {
        return Create(state, alt, context, semanticContext, null);
    }

    public static Antlr4.Runtime.Atn.ATNConfig Create([NotNull] ATNState state, int alt, PredictionContext? context, [NotNull] Antlr4.Runtime.Atn.SemanticContext semanticContext, LexerActionExecutor lexerActionExecutor)
    {
    ...
    public Antlr4.Runtime.Atn.ATNConfig Transform([NotNull] ATNState state, PredictionContext? context, bool checkNonGreedy)
    {
    ...
    private Antlr4.Runtime.Atn.ATNConfig Transform([NotNull] ATNState state, PredictionContext? context, [NotNull] Antlr4.Runtime.Atn.SemanticContext semanticContext, bool checkNonGreedy, LexerActionExecutor lexerActionExecutor)
    {
    ...
    private class SemanticContextATNConfig : ATNConfig
    {
        ...
        public SemanticContextATNConfig(Antlr4.Runtime.Atn.SemanticContext semanticContext, [NotNull] ATNState state, int alt, PredictionContext? context)
            : base(state, alt, context)
        {
            this.semanticContext = semanticContext;
        }

        public SemanticContextATNConfig(Antlr4.Runtime.Atn.SemanticContext semanticContext, [NotNull] ATNConfig c, [NotNull] ATNState state, PredictionContext? context)
    ...
    private class ActionATNConfig : ATNConfig
    {
        ...
        public ActionATNConfig(LexerActionExecutor lexerActionExecutor, [NotNull] ATNState state, int alt, PredictionContext? context, bool passedThroughNonGreedyDecision)
            : base(state, alt, context)
        {
        ...
        protected internal ActionATNConfig(LexerActionExecutor lexerActionExecutor, [NotNull] ATNConfig c, [NotNull] ATNState state, PredictionContext? context, bool passedThroughNonGreedyDecision)
            : base(c, state, context)
        {
    ...
    private class ActionSemanticContextATNConfig : ATNConfig.SemanticContextATNConfig
    {
        ...
        public ActionSemanticContextATNConfig(LexerActionExecutor lexerActionExecutor, [NotNull] SemanticContext semanticContext, [NotNull] ATNState state, int alt, PredictionContext? context, bool passedThroughNonGreedyDecision)
        ...
        public ActionSemanticContextATNConfig(LexerActionExecutor lexerActionExecutor, [NotNull] SemanticContext semanticContext, [NotNull] ATNConfig c, [NotNull] ATNState state, PredictionContext? context, bool passedThroughNonGreedyDecision)
