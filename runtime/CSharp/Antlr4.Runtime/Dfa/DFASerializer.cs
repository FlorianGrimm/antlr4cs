...
namespace Antlr4.Runtime.Dfa
{
    ...
    public class DFASerializer
    {
        ...
        public DFASerializer([NotNull] DFA dfa, string[]? tokenNames)
        ...
        public DFASerializer([NotNull] DFA dfa, IRecognizer? parser)
        ...
        public DFASerializer([NotNull] DFA dfa, string[]? tokenNames, string[]? ruleNames, ATN? atn)
            : this(dfa, Vocabulary.FromTokenNames(tokenNames), ruleNames, atn)
        {
        }

        public DFASerializer([NotNull] DFA dfa, [NotNull] IVocabulary vocabulary, string[]? ruleNames, ATN? atn)
        {
            this.dfa = dfa;
